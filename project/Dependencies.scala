...
object Dependencies {
  ...
  lazy val notifyJavaClient: ModuleID = "uk.gov.service.notify" % "notifications-java-client" % "3.19.2-RELEASE"
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.0.2.Final"
