...
object Dependencies {
  ...
  lazy val awsSecretsManager = "com.amazonaws.secretsmanager" % "aws-secretsmanager-caching-java" % "1.0.1"
  ...
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "2.10.0.Final"
