...
object Dependencies {
  ...
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.25.60"
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.11.0.CR1"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.25.60"
