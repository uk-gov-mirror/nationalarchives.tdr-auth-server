...
object Dependencies {
  ...
  lazy val notifyJavaClient: ModuleID = "uk.gov.service.notify" % "notifications-java-client" % "3.18.0-RELEASE"
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "2.13.1.Final"
